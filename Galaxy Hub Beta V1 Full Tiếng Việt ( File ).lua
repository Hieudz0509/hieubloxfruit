...
ToggleButton.Text = "mở lại ui"
ToggleButton.TextColor3 = Color3.fromRGB(255, 255, 255)
ToggleButton.TextSize = 0.000
...
local Window = OrionLib:MakeWindow({Name = "banana hub", HidePremium = false, IntroText = "banana hub", SaveConfig = true, ConfigFolder = "banana hub"})
----------Tab-----------------------
local W = Window:MakeTab({
    Name = "webhook",
    Icon = "rbxassetid://120100980412663",
    PremiumOnly = false
})
        ...
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Galaxy Hub(Noitification)",
                    Content = "[EN] : Please cancel the farrm level quest (if any)",
                    Image = "rbxassetid://120100980412663",
                    Time = 9
                })
                OrionLib:MakeNotification({
                    Name = "Galaxy Hub(Noitification)",
